...
<main>
    ...
    <div class="mainBody">
        ...
        <p>The Filipino Martial Arts, or FMA as we call it, is a lesser known sport but one of the fastest growing sports in the world. Not only is FMA a great sport, it’s easy for anybody to pick-up, and is one of the most effective self-defense systems in the world.</p>
        <p>Filipino martial arts (Filipino: Sining panlaban ng Pilipinas) refer to ancient Malay and newer modified fighting methods devised in the Philippines. It incorporates elements from both Western and Eastern Martial Arts, the most popular forms of which are known as <b>Arnis</b>, <b>Escrima</b>, and <b>Kali</b>.</p>
        ...
        <p>Practitioners of the arts are called arnisador (male, plural arnisadores) and arnisadora (female, plural arnisadoras) for those who call theirs arnis, Escrimador (male, plural Escrimadores) or Escrimadora (female, plural Escrimadoras) for those who call their art Escrima, and kalista or mangangali for those who practice kali.</p>
        <br/>
